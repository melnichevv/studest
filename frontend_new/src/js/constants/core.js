...
export const TEST_RESULT_STATUS_REQUIRES_REVIEW = 'REQUIRES_REVIEW';
export const TEST_RESULT_STATUS_REQUIRES_REVIEW_PRT = 'in review';
...
export const TEST_RESULT_STATUSES = {
  ...
  [TEST_RESULT_STATUS_REQUIRES_REVIEW]: [TEST_RESULT_STATUS_REQUIRES_REVIEW_PRT],
